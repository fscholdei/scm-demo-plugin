      ...
      <>
              ...
              <div className="columns">
                ...
                <div className="column">
                  ...
                  <p className="field">
                    ...
                    <a className="button">
                      <span className="icon">
                        <i className="fas fa-header fa-lg"> </i>
                      </span>
                    </a>
                  </p>
                  <p className="field">
                    ...
                    <a className="button is-medium">
                      <span className="icon is-medium">
                        <i className="fas fa-header fa-2x"> </i>
                      </span>
                    </a>
                  </p>
                  <p className="field">
            ...
            <section className="section" id="content">
              ...
              <div className="content">
                ...
                <p>
                  ...
                  pretium urna vel cursus venenatis. Suspendisse potenti. Etiam
                  mattis sem rhoncus lacus dapibus facilisis. Donec at dignissim
                ...
                <p>
                  ...
                  cursus non. Ut finibus eleifend arcu ut vehicula. Mauris eu
                  est maximus est porta condimentum in eu justo. Nulla id
                  iaculis sapien.{" "}
                </p>
                <table>
                  <thead>
                ...
                <p>
                  ...
                  nunc, blandit sed dapibus at, vestibulum in felis. Etiam
                  iaculis lorem ac nibh bibendum rhoncus. Nam interdum efficitur
                  ligula sit amet ullamcorper. Etiam tristique, leo vitae porta
                  faucibus, mi lacus laoreet metus, at cursus leo est vel
                  tellus. Sed ac posuere est. Nunc ultricies nunc neque, vitae
                  ultricies ex sodales quis. Aliquam eu nibh in libero accumsan
                  pulvinar. Nullam nec nisl placerat, pretium metus vel, euismod
                  ipsum. Proin tempor cursus nisl vel condimentum. Nam pharetra
                ...
                <p>
                  ...
                  euismod, elit vel rutrum commodo, ipsum tortor maximus dui,
              ...
              <div className="columns is-multiline">
                <div className="column is-half">
                  <div className="notification ">
                    ...
                    <a href="#">consectetur</a> adipiscing elit lorem ipsum
                ...
                <div className="column">
                  <div className="card">
                    ...
                    <div className="card-content">
                      <div className="media">
                        <div className="media-left">
                          <figure className={classNames("image", classes.c01)}>
                            <img
                ...
                <div className="media-content">
                  <div className="content">
                    <p>
                      ...
                      <br /> Lorem ipsum dolor sit amet, consectetur adipiscing
                      elit. Duis porta eros lacus, nec ultricies elit blandit
                      non. Suspendisse pellentesque mauris sit amet dolor
                    ...
                    <div className="media-content">
                      <div className="content">
                        <p>
                          ...
                          egestas. Aliquam blandit nisl a nulla sagittis, a
            ...
            <section className="section" id="modal">
              ...
              <a
                ...
                data-target="#myModal"
                onClick="$('#myModal').toggleClass('is-active')"
              >
...
export default injectSheet(styles)(DemoPage);
